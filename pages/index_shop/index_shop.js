...
Page({
  ...
  xaunzhong: function (e) {
    console.log(e)
    var id = e.currentTarget.dataset.id;
    console.log
    var that = this
    var index = e.currentTarget.dataset.index;
    var title_l = e.currentTarget.dataset.title_l;
    console.log(title_l)
    this.setData({
      ['where.sid']: id,
      ['where.page']: 1,
  ...
  onReady: function () {
    ...
    //     let tabScrollTop = rect.height;
    //     console.log(rect)
    //     let tabheight = tabScrollTop
    //     that.toHeight = tabheight
    //     console.log(that.toHeight)
    //   }).exec();
    // }, 300)
  },
  /**
