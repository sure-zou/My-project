 ...
 *
 */
export function getModifytext() {
  return request.get("user/modify_text");
}
 ...
 * 获取手机号
 * */
export function bd_getPhoneNumber(data) {
  return request.post("user_phone", data);
}
 ...
 * 上传图片
*/
export function getSharecreate(data) {
  return request.post('share/share_create', data)
}
/**
 * 分享
*/
export function getShareindex(data) {
  return request.get('share/index',data)
}
/**
 * 分享打卡
*/
export function getShareclock_in(data) {
  return request.get('share/clock_in ', data)
}

/**
 * 商家入驻
*/
export function getstore_business(data) {
  return request.post('store_business ', data)
}